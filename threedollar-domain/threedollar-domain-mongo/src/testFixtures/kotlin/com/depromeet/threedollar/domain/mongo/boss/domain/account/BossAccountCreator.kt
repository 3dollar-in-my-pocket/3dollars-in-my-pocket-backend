...
object BossAccountCreator {
    ...
    fun create(
        ...
        return com.depromeet.threedollar.domain.mongo.domain.bossservice.account.BossAccount(
            name = name,
            socialInfo = com.depromeet.threedollar.domain.mongo.domain.bossservice.account.BossAccountSocialInfo(
                socialId,
                socialType
            ),
