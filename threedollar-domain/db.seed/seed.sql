...
INSERT IGNORE INTO store_promotion (created_at, updated_at, introduction, icon_url, is_display_on_marker, is_display_on_the_detail) VALUES (NOW(), NOW(), '이 가게는 바삭하고 고소한<br>지니스에서 제조된</br> 반죽을 사용합니다', 'https://storage.prod.threedollars.co.kr/promotion/happy-promotion.png', 1, 1);


INSERT IGNORE INTO advertisement (platform_type, image_url, link_url, start_date_time, end_date_time, created_at, updated_at, position_type, title, sub_title, bg_color, font_color) VALUES ('AOS', 'https://storage.prod.threedollars.co.kr/popup/aos_popup_visit_history_2021_11_25.jpg', 'https://www.instagram.com/p/CWiAfy_PBAe/', '2021-11-25 00:00:00.000000', '2021-12-05 11:57:08.000000', NOW(), NOW(), 'SPLASH', null, null, null, null);
