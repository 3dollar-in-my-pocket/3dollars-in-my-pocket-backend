...
import static com.depromeet.threedollar.domain.rds.vendor.domain.store.QStoreDeleteRequest.storeDeleteRequest;

import java.util.List;

import com.depromeet.threedollar.domain.rds.vendor.domain.store.StoreStatus;
import com.depromeet.threedollar.domain.rds.vendor.domain.store.projection.QStoreWithReportedCountProjection;
