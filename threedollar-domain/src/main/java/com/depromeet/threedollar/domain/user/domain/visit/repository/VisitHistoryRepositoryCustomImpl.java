...
import com.depromeet.threedollar.domain.user.domain.visit.projection.QVisitHistoryCountProjection;
import com.depromeet.threedollar.domain.user.domain.visit.projection.QVisitHistoryWithUserProjection;
import com.depromeet.threedollar.domain.user.domain.visit.projection.VisitHistoryCountProjection;
...
import static com.depromeet.threedollar.domain.user.domain.visit.QVisitHistory.visitHistory;
