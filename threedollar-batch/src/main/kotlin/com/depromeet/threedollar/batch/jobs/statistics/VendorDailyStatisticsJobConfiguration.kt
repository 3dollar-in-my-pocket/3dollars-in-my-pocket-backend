...
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.COUNTS_ACTIVE_MEDAL
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.COUNTS_ACTIVE_MEDALS
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.COUNTS_DELETED_STORE
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.COUNTS_DELETE_STORE_REQUEST
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.COUNTS_MEDAL
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.COUNTS_MEDALS
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.COUNTS_MENU
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.COUNTS_MENUS
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.COUNTS_REVIEW
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.COUNTS_STORE
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.COUNTS_VISIT_HISTORY
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.COUNTS_Vendor
import com.depromeet.threedollar.batch.jobs.statistics.VendorDailyStatisticsMessageFormat.DAILY_STATISTICS_INFO
...
class DailyStatisticsJobConfiguration(
    ...
    private fun sendStatisticsNotification(
        messageType: VendorDailyStatisticsMessageFormat,
        totalCounts: Long,
        todayCounts: Long,
        weekendCounts: Long,
    ) {
