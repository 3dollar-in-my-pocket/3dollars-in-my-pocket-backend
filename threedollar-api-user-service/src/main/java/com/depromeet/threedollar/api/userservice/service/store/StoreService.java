...
import static com.depromeet.threedollar.common.exception.type.ErrorCode.E409_DUPLICATE_DELETE_REQUEST_STORE;
...
public class StoreService {
    ...
    public StoreDeleteResponse deleteStore(Long storeId, DeleteStoreRequest request, Long userId) {
        ...
        if (reporters.contains(userId)) {
            throw new ConflictException(String.format("사용자(%s)는 유저 가게(%s)에 대해 이미 삭제 요청을 하였습니다", userId, storeId), E409_DUPLICATE_DELETE_REQUEST_STORE);
        }
