...
internal class BossStoreCategoryControllerTest(
    ...
    fun `카테고리 목록이 캐시에 있을 경우, 캐시에서 가져온 데이터로 반환한다 - NOT EMPTY LIST`() {
        // given
        val category1 = BossStoreCategoryCacheModel.of(categoryId = "categoryId1", name = "한식", imageUrl = "https://icon1.png")
        val category2 = BossStoreCategoryCacheModel.of(categoryId = "categoryId1", name = "일식", imageUrl = "https://icon3.png")
