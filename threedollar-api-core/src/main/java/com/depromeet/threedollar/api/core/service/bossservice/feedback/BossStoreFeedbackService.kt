...
import com.depromeet.threedollar.api.core.service.bossservice.store.BossStoreCommonServiceHelper
...
class BossStoreFeedbackService(
    ...
    fun addFeedback(bossStoreId: String, request: AddBossStoreFeedbackRequest, userId: Long, date: LocalDate) {
        BossStoreCommonServiceHelper.validateExistsBossStore(bossStoreRepository, bossStoreId)
