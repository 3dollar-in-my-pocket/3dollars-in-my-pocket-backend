package com.depromeet.threedollar.admin.controller.user.advertisement

import com.depromeet.threedollar.admin.config.interceptor.Auth
import com.depromeet.threedollar.admin.service.user.advertisement.AdvertisementAdminService
import com.depromeet.threedollar.admin.service.user.advertisement.dto.request.AddAdvertisementRequest
import com.depromeet.threedollar.admin.service.user.advertisement.dto.request.RetrieveAdvertisementsRequest
import com.depromeet.threedollar.admin.service.user.advertisement.dto.request.UpdateAdvertisementRequest
import com.depromeet.threedollar.admin.service.user.advertisement.dto.response.AdvertisementsWithPagingResponse
