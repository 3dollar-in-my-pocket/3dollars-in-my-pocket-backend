...
import com.depromeet.threedollar.api.core.service.foodtruck.feedback.dto.response.BossStoreFeedbackGroupingDateResponse
...
import com.depromeet.threedollar.domain.mongo.foodtruck.domain.feedback.BossStoreFeedbackCreator
...
internal class BossStoreFeedbackControllerTest(
    ...
    inner class GetBossStoreFeedbacksCountsBetweenDateTest {
        ...
        @Test
        fun `특정 기간내의 특정 푸드트럭의 피드백 갯수를 조회합니다 이전 날에 더 피드백이 없는 경우`() {
            // given
        ...
        @Test
        fun `특정 기간내의 특정 푸드트럭의 피드백 갯수를 조회합니다 이전 날에 더 피드백이 있는경우`() {
            // given
            val feedbackType = BossStoreFeedbackType.BOSS_IS_KIND
            val date = LocalDate.of(2022, 1, 1)
