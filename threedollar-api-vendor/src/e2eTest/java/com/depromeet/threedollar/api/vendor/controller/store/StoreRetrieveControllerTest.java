...
import static com.depromeet.threedollar.api.vendor.controller.review.support.ReviewAssertions.assertReviewWithWriterResponse;
import static com.depromeet.threedollar.api.vendor.controller.store.support.StoreAssertions.assertMenuResponse;
import static com.depromeet.threedollar.api.vendor.controller.store.support.StoreAssertions.assertStoreDetailInfoResponse;
import static com.depromeet.threedollar.api.vendor.controller.store.support.StoreAssertions.assertStoreWithVisitsAndDistanceResponse;
import static com.depromeet.threedollar.api.vendor.controller.store.support.StoreAssertions.assertStoreWithVisitsResponse;
import static com.depromeet.threedollar.api.vendor.controller.store.support.StoreImageAssertions.assertStoreImageResponse;
import static com.depromeet.threedollar.api.vendor.controller.user.support.UserAssertions.assertUserInfoResponse;
import static com.depromeet.threedollar.api.vendor.controller.visit.support.VisitHistoryAssertions.assertVisitHistoryInfoResponse;
import static com.depromeet.threedollar.api.vendor.controller.visit.support.VisitHistoryAssertions.assertVisitHistoryWithUserResponse;
...
import com.depromeet.threedollar.api.vendor.service.store.dto.request.CheckExistsStoresNearbyRequest;
import com.depromeet.threedollar.api.vendor.service.store.dto.request.RetrieveAroundStoresRequest;
import com.depromeet.threedollar.api.vendor.service.store.dto.request.RetrieveMyStoresRequest;
import com.depromeet.threedollar.api.vendor.service.store.dto.request.RetrieveStoreDetailRequest;
import com.depromeet.threedollar.api.vendor.service.store.dto.response.CheckExistStoresNearbyResponse;
import com.depromeet.threedollar.api.vendor.service.store.dto.response.StoreDetailResponse;
import com.depromeet.threedollar.api.vendor.service.store.dto.response.StoreWithVisitsAndDistanceResponse;
import com.depromeet.threedollar.api.vendor.service.store.dto.response.StoresCursorResponse;
...
import com.depromeet.threedollar.domain.rds.vendor.domain.review.ReviewCreator;
...
import com.depromeet.threedollar.domain.rds.vendor.domain.store.MenuCreator;
...
import com.depromeet.threedollar.domain.rds.vendor.domain.store.StoreImageCreator;
...
import com.depromeet.threedollar.domain.rds.vendor.domain.visit.VisitHistoryCreator;
...
import com.depromeet.threedollar.domain.redis.domain.vendor.store.AroundVendorStoresCacheRepository;
import com.depromeet.threedollar.domain.redis.domain.vendor.store.VendorStoreCacheModel;
...
class StoreRetrieveControllerTest extends SetupUserControllerTest {
    ...
    @MockBean
    private AroundVendorStoresCacheRepository aroundVendorStoresCacheRepository;
    ...
    class RetrieveAroundStoresApiTest {
        ...
        @BeforeEach
        void disableCached() {
            when(aroundVendorStoresCacheRepository.get(anyDouble(), anyDouble(), anyDouble())).thenReturn(null);
            doNothing().when(aroundVendorStoresCacheRepository).set(anyDouble(), anyDouble(), anyDouble(), anyList());
        }
    ...
    class RetrieveAroundStoreApiCacheCheck {
        ...
        void 캐시에_주변_가게_데이터가_없는경우_DB에서_조회된_데이터들이_캐시에_저장된다() throws Exception {
            ...
            // then
            verify(aroundVendorStoresCacheRepository).set(anyDouble(), anyDouble(), anyDouble(), anyList());
        }
        ...
        void 캐시에_주변_가게_데이터가_있다면_DB_조회없이_캐시에서_조회해서_반환한다() throws Exception {
            ...
            VendorStoreCacheModel cachedStore = VendorStoreCacheModel.of(
            ...
            when(aroundVendorStoresCacheRepository.get(anyDouble(), anyDouble(), anyDouble())).thenReturn(List.of(cachedStore));
        ...
        void 캐시에_있는_가게들중_카테고리를_필터링해서_반환한다() throws Exception {
            ...
            VendorStoreCacheModel noMatchedStore = VendorStoreCacheModel.of(
                List.of(UserMenuCategoryType.SUNDAE, UserMenuCategoryType.WAFFLE),
                100L,
                latitude,
                longitude,
            ...
            VendorStoreCacheModel matchedStore = VendorStoreCacheModel.of(
            ...
            when(aroundVendorStoresCacheRepository.get(anyDouble(), anyDouble(), anyDouble())).thenReturn(List.of(noMatchedStore, matchedStore));
