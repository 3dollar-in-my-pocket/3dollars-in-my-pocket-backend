...
import static com.depromeet.threedollar.api.vendor.service.store.StoreServiceUtils.findAroundStoresFilerByCategory;
...
import com.depromeet.threedollar.domain.rds.vendor.collection.user.UserDictionary;
...
public class StoreRetrieveService {
    ...
    private final AroundVendorStoresCacheRepository aroundVendorStoresCacheRepository;
    ...
    public List<StoreWithVisitsAndDistanceResponse> retrieveAroundStores(RetrieveAroundStoresRequest request, LocationValue deviceLocation, LocationValue mapLocation) {
        List<StoreInfoResponse> aroundStoresFilerByCategory = findAroundStoresFilerByCategory(storeRepository, aroundVendorStoresCacheRepository, mapLocation.getLatitude(), mapLocation.getLongitude(), request.getDistance(), request.getCategory());
