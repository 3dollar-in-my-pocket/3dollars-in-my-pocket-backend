...
public class JsonUtils {
    ...
    public static <T> T toObject(String input, Class<T> toClass) {
        try {
            ...
            throw new IllegalArgumentException(String.format("역직렬화 중 에러가 발생하였습니다. message: (%s)", e.getMessage()));
        }
    }
    ...
    public static <T> String toJson(T input) {
        ...
        try {
            ...
            throw new IllegalArgumentException(String.format("직렬화 중 에러가 발생하였습니다. message: (%s)", e.getMessage()));
        }
    }
