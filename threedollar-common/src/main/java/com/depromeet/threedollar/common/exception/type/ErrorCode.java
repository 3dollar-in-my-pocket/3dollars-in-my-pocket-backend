...
public enum ErrorCode {
    ...
    INVALID_MISSING_LATITUDE(BAD_REQUEST, OFF, "BR101", "현재 위치의 위도를 입력해주세요 (latitude)"),
    INVALID_MISSING_LONGITUDE(BAD_REQUEST, OFF, "BR102", "현재 위치의 경도를 입력해주세요 (longitude)"),
    INVALID_MISSING_MAP_LATITUDE(BAD_REQUEST, OFF, "BR103", "지도상 위도를 입력해주세요 (mapLatitude)"),
    INVALID_MISSING_MAP_LONGITUDE(BAD_REQUEST, OFF, "BR104", "지도상 경도를 입력해주세요 (mapLongitude)"),
    ...
    INVALID_LATITUDE_RANGE(BAD_REQUEST, OFF, "BR204", "잘못된 위도 범위를 입력하였습니다\n(33.1 ~ 38.61 사이의 위도를 입력해주세요)"),
    INVALID_LONGITUDE_RANGE(BAD_REQUEST, OFF, "BR205", "잘못된 경도 범위를 입력하였습니다\n(124.60 ~ 131.87 사이의 경도를 입력해주세요)"),
    ...
    NOTFOUND_MEDAL(NOT_FOUND, OFF, "N006", "보유하고 있지 않은 메달입니다"),
    NOTFOUND_CATEGORY(NOT_FOUND, OFF, "N007", "존재하지 않는 카테고리 입니다"),
    NOTFOUND_BOSS(NOT_FOUND, OFF, "N008", "존재하지 않는 사장님 계정입니다"),
    NOTFOUND_BOSS_OWNED_STORE(NOT_FOUND, OFF, "NF009", "사장님이 운영하는 가게가 존재하지 않습니다."),
    NOTFOUND_SIGNUP_REGISTRATION(NOT_FOUND, OFF, "NF010", "해당하는 가입 신청은 존재하지 않습니다"),


    // 405 Method Not Allowed
    METHOD_NOT_ALLOWED(HttpStatusCode.METHOD_NOT_ALLOWED, OFF, "MN000", "Not Allowed Method"),


    // 406 Not Acceptable
    NOT_ACCEPTABLE(HttpStatusCode.NOT_ACCEPTABLE, OFF, "NA000", "Not Acceptable"),
    ...
    INTERNAL_SERVER_UPDATE_STORE_OPTIMISTIC_LOCK_FAILED(HttpStatusCode.INTERNAL_SERVER, ON, "IS002", "일시적으로 다른 사용자와 동시에 가게 수정 요청을 하였습니다ㅠㅠ\n잠시 후 다시 시도해주세요!"),


    // 502 Bad Gateway
    BAD_GATEWAY(HttpStatusCode.BAD_GATEWAY, ON, "BG000", "일시적인 에러가 발생하였습니다.\n잠시 후 다시 시도해주세요!"),
