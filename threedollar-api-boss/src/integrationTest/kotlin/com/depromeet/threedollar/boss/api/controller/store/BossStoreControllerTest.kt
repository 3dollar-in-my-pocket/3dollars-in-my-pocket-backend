...
import com.depromeet.threedollar.boss.api.service.store.dto.response.BossStoreAppearanceDayResponse
import com.depromeet.threedollar.boss.api.service.store.dto.response.BossStoreCategoryResponse
import com.depromeet.threedollar.boss.api.service.store.dto.response.BossStoreMenuResponse
...
internal class BossStoreControllerTest(
    ...
    fun `특정 가게를 조회합니다 오픈 정보가 레디스에 저장되어 있으면 영업중인 가게로 표시된다`() {
        ...
        bossStoreOpenInfoRepository.save(BossStoreOpenInfoCreator.create(bossStore.id, LocalDateTime.of(2022, 2, 1, 0, 0)))
