...
internal class RegistrationServiceTest(
    ...
    fun `신규 가입을 신청하면 Registration 데이터가 추가된다`() {
        ...
        val storeCategories = listOf("1", "2")
        ...
        registrations[0].store.let {
            ...
            assertThat(it.categories).containsExactlyInAnyOrderElementsOf(storeCategories)
